...
def Ref():
    ...
    adoboprice = adobo*15
    adobongbaboyprice = adobongbaboy*20
    hiponprice = hipon*25
    karikariprice = karikari*35
    paksiwprice = paksiw*18
    drinksprice = drinkwine*10
...
lblmanok = Label(f1, font=('aria' , 16, 'bold'), text="Idly and Sambar", fg="green", bd=10, anchor='w')
...
lblbaboy = Label(f1, font=('aria' , 16, 'bold'), text="Dosa", fg="green", bd=10, anchor='w')
...
lblhipon = Label(f1, font=('aria' , 16, 'bold'), text="Vada", fg="green", bd=10, anchor='w')
...
lblkarikari = Label(f1, font=('aria' , 16, 'bold'), text="Poha", fg="green", bd=10, anchor='w')
...
lblpaksiw = Label(f1, font=('aria' , 16, 'bold'), text="Chapathi", fg="green", bd=10, anchor='w')
...
#--------------------------------------------------------------------------------------
lblmountaindew = Label(f1, font=('aria' , 16, 'bold'), text="Water Bottles", fg="green", bd=10, anchor='w')
...
def price():
    ...
    lblrestaurant = Label(roo, font=('aria', 15, 'bold'), text="Idly and Sambar", fg="red", anchor=W)
    ...
    lblrestaurant = Label(roo, font=('aria', 15, 'bold'), text="Dosa", fg="red", anchor=W)
    ...
    lblrestaurant = Label(roo, font=('aria', 15, 'bold'), text="Vada", fg="red", anchor=W)
    lblrestaurant.grid(row=3, column=0)
    lblrestaurant = Label(roo, font=('aria', 15, 'bold'), text="25", fg="red", anchor=W)
    lblrestaurant.grid(row=3, column=3)
    lblrestaurant = Label(roo, font=('aria', 15, 'bold'), text="Poha", fg="red", anchor=W)
    lblrestaurant.grid(row=4, column=0)
    lblrestaurant = Label(roo, font=('aria', 15, 'bold'), text="35", fg="red", anchor=W)
    lblrestaurant.grid(row=4, column=3)
    lblrestaurant = Label(roo, font=('aria', 15, 'bold'), text="Chapathi", fg="red", anchor=W)
    lblrestaurant.grid(row=5, column=0)
    lblrestaurant = Label(roo, font=('aria', 15, 'bold'), text="18", fg="red", anchor=W)
    lblrestaurant.grid(row=5, column=3)
    lblrestaurant = Label(roo, font=('aria', 15, 'bold'), text="Water bottle", fg="red", anchor=W)
